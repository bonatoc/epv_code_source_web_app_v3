...
.config(function($stateProvider, $urlRouterProvider, $sceDelegateProvider, $translateProvider, $mdThemingProvider, $compileProvider) {
...
blue-grey
	...
	*/
	...
	// $compileProvider.aHrefSanitizationWhitelist(/^\s*(file|tel|fax):/);
   ...
   // cache: false,
    ...
    .state('tab.products', {
     ...
     // cache: false,
        ...
        views: {
          'tab-dash': { // REQUIRED FOR HISTORY STACKS AND THEREFORE PAGE TRANSITIONS (? TODO: INVESTIGATE)
            templateUrl: 'templates/tab-products2.html',
	  ...
	  .state('tab.categories', {
		  ...
		  params: { categoryID: 4, serviceID: 35},
	   // cache: false,
		  // abstract: true,
		...
		// TAB 2, "TOOLS" (MEDIAS) 
		  ...
		  params: { assetCategoryID: 1, assetGalleryID: 1 },
